...
export type ConfigSchema = {
  base: number
  baseline: { variant: BaselineVariant; debugging: DebuggingMode; colors: Record<BaselineVariant, string> }
  guide: { variant: GuideVariant; debugging: DebuggingMode; colors: Record<GuideVariant, string> }
